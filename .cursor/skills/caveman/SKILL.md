...
name: caveman
description: >
  Ultra-compressed communication mode for Asterfold agent sessions. Cuts output
  tokens by speaking like caveman while keeping full technical accuracy.
  Asterfold default intensity is ultra. Use at the start of every task, when the
  user says "caveman mode", "talk like caveman", "use caveman", "less tokens",
  "be brief", or invokes /caveman or /caveman ultra.
---
...
Asterfold default: **ultra**. Switch: `/caveman lite|full|ultra|wenyan-lite|wenyan-full|wenyan-ultra|off`.
...
This file is the Asterfold-vendored copy of the public caveman skill (MIT), with project default intensity set to ultra.
