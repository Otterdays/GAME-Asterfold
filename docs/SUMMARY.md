...
Title shell launches Mara into graybox Brindlewick. Peek camera, eight-direction presentation, separate grass and dirt-road surfaces, accessibility settings, and `validate.bat` exist. This is not a game demo.
...
4. Move: WASD or left stick. Peek: Space+WASD or right stick. Field help: F1 / Start. Return: Escape / B
